...
TASK_CONFIGS = {
    ...
    'give_bag':{
        'dataset_dir': DATA_DIR + '/give_bag',
        'episode_len': 1000,
        'camera_names': ['cam_high', 'cam_left_wrist', 'cam_right_wrist']
    },
    'grip_bottle':{
        'dataset_dir': DATA_DIR + '/grip_bottle',
        'episode_len': 2000,
        'camera_names': ['cam_high', 'cam_left_wrist', 'cam_right_wrist']
    },
    'play_chess':{
        'dataset_dir': DATA_DIR + '/play_chess',
        'episode_len': 800,
        'camera_names': ['cam_high', 'cam_left_wrist', 'cam_right_wrist']
    },
    'toast':{
        'dataset_dir': DATA_DIR + '/toast',
        'episode_len': 2000,
        'camera_names': ['cam_high', 'cam_left_wrist']
    },
    'sort_chess':{
        'dataset_dir': DATA_DIR + '/sort_chess',
        'episode_len': 800,
        'camera_names': ['cam_high', 'cam_left_wrist', 'cam_right_wrist']
    },
